...
const ThreeCity = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Use ref.current instead of document.body
    // Three JS Template
    //----------------------------------------------------------------- BASIC parameters
    ...
    // Cleanup
    return () => {
      // Cleanup Three.js and GSAP resources
      if (containerRef.current && canvas) {
        // Only remove the canvas if both the container and the canvas exist
